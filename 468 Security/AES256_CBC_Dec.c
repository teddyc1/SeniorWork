...
int main(int argc, char *argv[]){
	if(argc != 9){
		printf("Too many, or not enough arguments. Use the following format: AES256_CBC_Dec –k <key file> -v <IV file> -i <input file> -o <output file>.\n");
		exit(0);
	}
	...
	EVP_CipherInit_ex(ctx, EVP_aes_256_cbc(), NULL, key, iv, 0);//1 encryption, 0 decryption
