...
int main(int argc, char *argv[]){
	if(argc != 7){
		printf("Too many, or not enough arguments. Use the following format: DES_ECB_Dec –k <key file> -i <input file> -o <output file>.\n");
		exit(0);
	}
	...
	// This is the Decryption version, same code 1 variable is changed
	// ~~~
	...
	EVP_CipherInit_ex(ctx, EVP_des_ecb(), NULL, key, NULL, 0);//1 encryption, 0 decryption
